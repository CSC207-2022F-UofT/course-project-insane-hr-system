...
public class BooleanEvaluationTask extends CommonOrganization implements Task {
    ...
    public BooleanEvaluationTask(int oid, String name, Integer head, Set<Integer> members, String description, LocalDateTime creatTime, LocalDateTime closeTime, Task evaluatedTask, Project project) {
        super(oid, name, head, members, description, creatTime, closeTime);
        this.evaluatedTask = evaluatedTask;
        this.project = project;
    }

    public BooleanEvaluationTask(int oid, String name, Integer head, Set<Integer> members, String description, LocalDateTime creatTime, Task evaluatedTask, Project project) {
