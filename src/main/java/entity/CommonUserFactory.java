...
public class CommonUserFactory implements UserFactory {
    ...
    public User create(int uid, Department dpt, String bio, String username, String password, List<String> roles,
                       List<Project> projects, List<Task> tasks, String position, LocalDate onboardDate, int vacationDays) {
        UserFile userFile = new UserFile(uid, username, password, roles, projects, tasks, position, onboardDate, vacationDays);
