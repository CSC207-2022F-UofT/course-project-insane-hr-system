...
public class ProjectScreenForEeBuilder extends ProjectScreenBuilder{
    public ProjectScreenForEeBuilder(UIDataModel dataModel) {
        super(dataModel);
    }
    ...
    public static void main(String[] args) {
        ...
        ScreenBuilder builder = new ProjectScreenForEeBuilder(model);
