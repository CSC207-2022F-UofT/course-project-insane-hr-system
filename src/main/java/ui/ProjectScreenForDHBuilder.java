...
public class ProjectScreenForDHBuilder extends ProjectScreenBuilder{
    public ProjectScreenForDHBuilder(UIDataModel dataModel) {
        super(dataModel);
    }
    ...
    public static void main(String[] args) {
        ...
        ScreenBuilder builder = new ProjectScreenForDHBuilder(model);
