...
public class TaskScreenForEeBuilder extends TaskScreenBuilder{
    public TaskScreenForEeBuilder(UIDataModel dataModel) {
        super(dataModel);
    }
    ...
    public static void main(String[] args) {
        ...
        ScreenBuilder builder = new TaskScreenForEeBuilder(model);
