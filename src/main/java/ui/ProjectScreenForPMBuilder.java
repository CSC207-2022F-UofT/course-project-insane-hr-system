...
public class ProjectScreenForPMBuilder extends ProjectScreenBuilder{
    public ProjectScreenForPMBuilder(UIDataModel dataModel) {
        super(dataModel);
    }
    ...
    public static void main(String[] args) {
        ...
        ScreenBuilder builder = new ProjectScreenForPMBuilder(model);
